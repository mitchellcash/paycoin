...
#ifndef BUILD_DESC
#    ifdef GIT_COMMIT_ID
#        define BUILD_DESC BUILD_DESC_FROM_COMMIT(PAYCOIN_VERSION_MAJOR, PAYCOIN_VERSION_MINOR, PAYCOIN_VERSION_REVISION, PAYCOIN_VERSION_BUILD, GIT_COMMIT_ID)
#    else
#        define BUILD_DESC BUILD_DESC_FROM_UNKNOWN(PAYCOIN_VERSION_MAJOR, PAYCOIN_VERSION_MINOR, PAYCOIN_VERSION_REVISION, PAYCOIN_VERSION_BUILD)
#    endif
#endif
